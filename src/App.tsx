...
export default function App() {
  ...
  if (authLoading) {
    return (
      <div className="fixed inset-0 bg-slate-950 flex flex-col items-center justify-center z-50">
        <div className="w-12 h-12 border-4 border-indigo-500/20 border-t-indigo-500 rounded-full animate-spin mb-5" />
        <div className="text-slate-400 font-black text-[10px] uppercase tracking-[0.2em] animate-pulse">
  ...
  return (
    <div id="app-root-container" className="min-h-screen bg-slate-950 flex flex-col font-sans text-slate-100 antialiased selection:bg-indigo-500 selection:text-white">
          ...
          <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 mt-5 -mb-2">
            {globalError && (
              <motion.div 
                ...
                className="bg-rose-50 border border-rose-200/60 rounded-2xl p-4 flex items-start gap-3 shadow-md shadow-rose-100/40 transition-colors duration-300 touch-none cursor-grab active:cursor-grabbing"
              >
                <div className="bg-rose-100 text-rose-600 rounded-xl p-2 shrink-0">
                ...
                <button 
                  ...
                  className="text-xs font-black text-rose-600 hover:text-rose-800 bg-rose-100/50 hover:bg-rose-100 px-2.5 py-1.5 rounded-lg transition"
                >
                  Dismiss
                </button>
              </motion.div>
            ...
            {successMsg && (
              <motion.div 
                ...
                className="bg-emerald-50 border border-emerald-250 rounded-2xl p-4 flex items-start gap-3 shadow-md shadow-emerald-100/40 transition-colors duration-300 touch-none cursor-grab active:cursor-grabbing"
              >
                ...
                <button 
                  ...
                  className="text-xs font-black text-emerald-600 hover:text-emerald-800 bg-emerald-150 hover:bg-emerald-200 px-2.5 py-1.5 rounded-lg transition"
                >
                  Dismiss
                </button>
              </motion.div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8">
        ...
        {activeTab === 'announcements' && (
          <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-800 pb-5">
              <div>
                <h2 className="text-3xl font-black text-white tracking-tight">About Pratap</h2>
                <p className="text-sm text-slate-400 mt-1">Official inter-institutional athletics meet hosted by IISER Kolkata.</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs bg-indigo-950/50 text-indigo-300 font-bold px-3 py-1.5 rounded-full border border-indigo-500/20 flex items-center gap-1">
            ...
            {/* About Us Section */}
            <div className="bg-slate-900 rounded-3xl border border-slate-800 p-8 shadow-2xl shadow-black/20 space-y-6">
              <div className="flex flex-col items-center justify-center gap-8 border-b border-slate-800 pb-8 text-center">
                {/* Visual Banner Background behind logos */}
                <div className="relative group shrink-0">
                  <div className="absolute -inset-4 bg-gradient-to-r from-indigo-500 via-rose-500 to-amber-500 rounded-[2.5rem] opacity-20 blur-2xl group-hover:opacity-40 transition-opacity duration-700" />
                  <div className="relative flex items-center gap-6 bg-slate-950/80 rounded-[2rem] p-8 sm:p-10 border border-slate-700/50 backdrop-blur-sm shadow-2xl overflow-hidden">
                    {/* Decorative pattern for the banner background */}
                    <div className="absolute inset-0 opacity-10 pointer-events-none">
                      ...
                      <div className="flex gap-1.5 h-full w-full">
                        {Array.from({ length: 12 }).map((_, i) => (
                          <div key={i} className="w-full h-full border-r border-slate-700/30 -skew-x-12" />
                        ))}
                      </div>
                    </div>
                    
                    <div className="relative z-10 flex items-center gap-6">
                      <ClubLogo className="h-32 w-32 sm:h-44 sm:w-44 md:h-48 md:w-48 drop-shadow-[0_0_20px_rgba(99,102,241,0.4)] transition-transform duration-500 group-hover:scale-105" logoUrl={appLogo} />
                      <div className="w-px h-24 bg-gradient-to-b from-transparent via-slate-700 to-transparent" />
                      <ClubLogo className="h-32 w-32 sm:h-44 sm:w-44 md:h-48 md:w-48 drop-shadow-[0_0_20px_rgba(245,158,11,0.4)] transition-transform duration-500 group-hover:scale-105" logoUrl={clubLogo} />
                    </div>
                  </div>
                </div>
                <div className="space-y-4 max-w-3xl">
                  <h3 className="text-3xl sm:text-4xl font-black text-white tracking-tight font-serif">The Pratap Legacy</h3>
                  <p className="text-slate-300 leading-relaxed font-medium sm:text-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed font-medium">
                    <strong className="text-indigo-400">Pratap</strong> is primarily an inter-institute athletics competition designed for <strong className="text-white">IISER Kolkata</strong> and other premier educational institutes located in its nearby locality. 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs font-bold text-slate-200 truncate">pratap@iiserkol.ac.in</p>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Instagram</p>
                        <p className="text-xs font-bold text-slate-200 truncate">@athletics.iiserk</p>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">YouTube</p>
                        <p className="text-xs font-bold text-slate-200 truncate">@pratapathleticsmeet</p>
                      </div>
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-indigo-950/30 rounded-2xl p-6 border border-indigo-500/10 mt-4 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-amber-950 to-amber-900/50 p-6 rounded-2xl border border-amber-500/20 flex items-center gap-4 card-lift-sm animate-fade-slide-up stagger-1">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-200">Competitions</h4>
              ...
              <div className="bg-gradient-to-br from-emerald-950 to-emerald-900/50 p-6 rounded-2xl border border-emerald-500/20 flex items-center gap-4 card-lift-sm animate-fade-slide-up stagger-2">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-200">Performance Logs</h4>
        ...
        {activeTab === 'results' && (
          <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-800 pb-5">
              <div>
                <h2 className="text-3xl font-black text-white tracking-tight">Eventwise Performance & Results</h2>
                <p className="text-sm text-slate-400 mt-1">Select any athletic event to review historic competition metrics accompanied by official athlete trial photographs.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div className="space-y-6">
                {/* Plot stats analysis of historical events */}
                <DashboardView 
        ...
        {activeTab === 'competitions' && (
          <div className="space-y-8 animate-fade-in">
            <div className="border-b border-slate-800 pb-6">
              <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tighter">Tournament Schedules</h2>
              <p className="text-base sm:text-lg text-slate-400 mt-2 max-w-3xl leading-relaxed">Browse scheduled tournaments hosted or attended by IISER Kolkata. प्रताप/Pratap (Institutional championships) are managed here.</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-sky-800 to-indigo-950 p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
                  <div className="absolute right-4 top-4 opacity-10 font-bold font-mono text-8xl select-none text-white">PRTAP</div>
                  <span className="text-sm font-extrabold uppercase tracking-widest text-sky-300 block mb-1">Intra-mural Trophy Track</span>
                    ...
                    competitions.filter(c => c.tier === 'Pratap').map((c, idx) => (
                      <div key={c.id} className={`bg-slate-900 rounded-2xl border border-slate-800 p-6 shadow-xs relative card-lift animate-fade-slide-up stagger-${(idx % 5) + 1}`}>
                        ...
                        <div className="space-y-1.5 max-w-[80%]">
                          <h4 className="font-extrabold text-white text-xl leading-snug">{c.title}</h4>
                          <div className="flex flex-wrap gap-2 text-sm text-slate-400 font-bold font-mono pt-1">
                        ...
                        <p className="text-sm text-slate-300 leading-relaxed mt-5 font-medium">{c.description}</p>

                        <div className="mt-4 border-t border-slate-800 pt-4 flex items-center justify-between gap-2">
                          <div>
                            <span className="text-[10px] font-extrabold text-slate-600 uppercase block">Disciplines Scheduled</span>
                            <div className="flex flex-wrap gap-1 mt-1">
                              {c.events.map(ev => (
                                <span key={ev} className="bg-slate-800 text-slate-300 text-[10px] font-bold px-2 py-0.5 rounded-md">{ev}</span>
                              ))}
                            </div>
                          </div>

                          <div className="text-right">
                            <span className="text-[10px] font-extrabold text-slate-600 uppercase block">Registered Athletes</span>
                            <span className="text-xs font-extrabold text-slate-300">{c.registeredAthleteIds.length} Squad Athletes</span>
                          </div>
                        </div>

                        {/* Interactive registration block for spectator convenience */}
                        <div className="mt-4 bg-slate-950 rounded-xl p-3 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
                          <span className="text-xs font-semibold text-slate-400">Represent IISER-K Athletics Hub?</span>
                          <button
                            onClick={() => {
                            ...
                            className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black px-4 py-2 rounded-xl transition shadow-lg shadow-indigo-900/20"
                          >
        ...
        {/* TAB 5: ADMIN SIGN-IN WITH ID & PASSWORD */}
        {activeTab === 'admin' && (
          <div className="space-y-8 animate-fade-in">
            ...
            {isAuthorizedAdmin ? (
              <div className="space-y-6">
                ...
                <div className="bg-slate-900 rounded-3xl border border-slate-800 p-6 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-black bg-emerald-500/10 text-emerald-400 px-3 py-0.5 rounded-full border border-emerald-500/20 tracking-wider uppercase">
                          ADMINISTRATOR SESSION
                        </span>
                        <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                      </div>
                      <p className="text-sm font-extrabold text-white mt-1">
                        Signed in as Admin ID: <span className="font-mono text-indigo-400 bg-indigo-950/60 px-2 py-0.5 rounded border border-indigo-800">{currentUserEmail || adminCredentials.id}</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 w-full md:w-auto">
                    <button
                      ...
                      className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs px-4 py-2.5 rounded-xl transition shadow-lg shadow-indigo-950/30 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 md:flex-none bg-slate-800 hover:bg-slate-700 text-slate-200 font-extrabold text-xs px-4 py-2.5 rounded-xl transition cursor-pointer border border-slate-700"
                    >
                      Sign Out
                    </button>
                  </div>
              ...
              <div className="max-w-md mx-auto my-8">
                ...
                <div id="admin-login-card" className="relative group bg-slate-900 border border-slate-800 rounded-[36px] p-8 sm:p-10 space-y-6 shadow-2xl overflow-hidden text-center">
                  ...
                  <div className="relative mx-auto h-20 w-20 flex items-center justify-center">
                    <div className="absolute inset-0 bg-indigo-500/10 rounded-full scale-110 animate-pulse"></div>
                    <div className="relative h-14 w-14 bg-indigo-600 text-white rounded-2xl flex items-center justify-center shadow-xl z-10">
                      <Lock className="h-7 w-7" />
                    </div>
                  </div>

                  <div className="space-y-1 relative z-10">
                    <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight font-serif">Admin Login</h2>
                  ...
                  <form onSubmit={handleIdPasswordLogin} className="space-y-4 text-left relative z-10">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-950 border border-slate-800 text-sm px-4 py-3 rounded-xl font-medium text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-800 text-sm px-4 py-3 pr-11 rounded-xl font-medium text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                        />
                        <button
                          type="button"
                    ...
                    {errorMsg && (
                      <div className="bg-rose-950/50 border border-rose-500/30 rounded-xl p-3 text-xs text-rose-300 font-bold flex items-center gap-2">
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-sm px-6 py-3.5 rounded-xl shadow-lg shadow-indigo-950/40 transition active:scale-95 cursor-pointer mt-2"
                    >
          ...
          {isChangeCredsOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
              <motion.div
                ...
                className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6"
              >
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h3 className="text-lg font-black text-white">Change Admin Credentials</h3>
                      <p className="text-[11px] font-medium text-slate-400">Update your Admin ID & Password for future logins</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setIsChangeCredsOpen(false)}
                    className="text-slate-500 hover:text-white transition p-1 font-bold text-lg"
                  >
                    ✕
                  </button>
                </div>
                ...
                <form onSubmit={handleSaveNewCredentials} className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 text-sm px-4 py-2.5 rounded-xl font-medium text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-300">New Admin ID / Username</label>
                    <input
                      type="text"
                      required
                      placeholder="e.g. admin"
                  ...
                  {changeCredsError && (
                    <div className="bg-rose-950/50 border border-rose-500/30 rounded-xl p-3 text-xs text-rose-300 font-bold">
                      {changeCredsError}
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    <button
                      type="submit"
                      className="flex-1 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs py-2.5 rounded-xl transition shadow-lg shadow-indigo-950/40"
                    >
                      Save Credentials
                    </button>
                  </div>
      ...
      <footer id="app-footer" className="mt-auto border-t border-slate-800 bg-slate-950 py-8 text-center text-xs text-slate-500">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-2">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-slate-900 border border-slate-800 rounded-xl flex items-center justify-center">
                <ClubLogo className="h-6 w-6" logoUrl={appLogo} />
              </div>
              <div className="text-left">
                <span className="block font-black text-slate-200 uppercase tracking-tight">IISER Kolkata Athletics</span>
                <span className="text-[10px] text-slate-600 font-bold uppercase tracking-widest">Sports Secretariat Council</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              <a 
                href="mailto:pratap@iiserkol.ac.in"
                className="flex items-center gap-2 text-slate-400 hover:text-indigo-400 font-bold transition bg-slate-900/50 border border-slate-800 px-3 py-1.5 rounded-lg"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-slate-400 hover:text-rose-400 font-bold transition bg-slate-900/50 border border-slate-800 px-3 py-1.5 rounded-lg"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-slate-400 hover:text-red-500 font-bold transition bg-slate-900/50 border border-slate-800 px-3 py-1.5 rounded-lg"
              >
          ...
          <div className="border-t border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px]">
